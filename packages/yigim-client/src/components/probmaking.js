...
class ProbMaking extends Component {
  state = {
    ...
    QnAExSets: [
      {
        id: 1,
        question: this.props.match.params.id + '의 주량은?',
        answer: ['1병', '2병', '3병', '반 병병병병병병'],
        score: 3,
      },
      {
        id: 2,
        question: this.props.match.params.id + '의 입대 날짜는?',
        answer: ['17년 2월', '18년 2월', '19년 2월', '미필'],
        score: 3,
      },
      {
        id: 3,
        question: this.props.match.params.id + '의 나이는?',
        answer: ['10살', '20살', '22살', '30살'],
        score: 3,
      },
      {
        id: 4,
        question: this.props.match.params.id + '의 가족관계는?',
    ...
    AdditionalQnASets: [
      {
        id: 1,
        question: this.props.match.params.id + '의 연애 상태는?',
        answer: ['연애하는 중', '연애하지 않는 중', '썸타는 중'],
        score: 3,
      },
      {
        id: 2,
        question: this.props.match.params.id + '가 좋아하는 활동은?',
        answer: ['야외 활동', '실내 활동'],
        score: 3,
      },
      {
        id: 3,
        question: this.props.match.params.id + '가 다닌 고등학교는?',
      ...
      {
        id: 10,
        question: this.props.match.params.id + '가 가장 좋아하는 생선은?',
        answer: ['고등어', '갈치', '생일선물'],
        score: 3,
      },
    ],
            ...
            if (this.state.mode === 'basic') {
              ...
              //다음 문제로 가면 추천 문제 리스트의 그 다음 문항부터 추천해주기 위함.
                ...
                this.setState({
                  ...
                  UserQnASets: this.state.UserQnASets.concat({
                    id: this.probNumber,
                    picked_number: k - 9,
                    question: show_question,
                    answer: answers_each,
                    score: this.state.QnAExSets[this.probNumber - 1].score,
                  }),
                });
              }
              if (this.probNumber === 10) {
                //축적된 데이터(UserQnALists) 업로드하도록
                this.props.history.push('/prob-making-done', {
          ...
          <div className="Choice">
            <ol>
              ...
              <input
                ...
                id="next"
                type="submit"
                value={this.probNumber === 9 ? '제출하기' : '다음문제'}
              ></input>
            </ol>
          </div>
        </form>
